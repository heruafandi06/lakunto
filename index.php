...
<body>
	<div id="main">
		...
		<div id="logo"><img src="images/img/logo.png"></div>
			...
			<div class="tengah">
				<div class="background_pjg">Selamat Datang di Lakunto</div>
				<div style="position:relative;top:10px;left:15px;font-size:12px;padding:2px;">Kami menyediakan handphone android berbagai brands.</div>
			</div>
			<div class="kanan">
